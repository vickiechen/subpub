...
(function ($) {
    ...
    $.fn.w2tag = function (text, options) {
        ...
        options = $.extend({
            ...
            hideOnMouseOut  : false     // hide tag on mouse out
        }, options);
        ...
        return $(this).each(function (index, el) {
            ...
            setTimeout(function () {
                ...
                if (options.hideOnMouseOut) {
                    $(document).on('mouseout.w2tag', hideTag)
                }
    ...
    w2grid.prototype = {
        ...
        initColumnOnOff: function () {
            ...
            for (var c = 0; c < this.columns.length; c++) {
                ...
                if (col.hideable === false || col.hideable === 0) continue; //edited by ke314w 10/26/2016
        ...
        initColumnDrag: function ( box ) {
            ...
            var obj = this,
                _dragData = {};
            _dragData.lastInt = undefined; //Custom Change by ke314w on 10-06-2016
            ...
            function dragColOver ( event ) {
                ...
                var cursorX = event.originalEvent.clientX, //originally pageX, Custom Change by ke314w
                    cursorY = event.originalEvent.clientY, //originally pageY, Custom Change by ke314w
        ...
        getCellHTML: function (ind, col_ind, summary, col_span) {
            ...
            if (col.info != null) {
                ...
                infoBubble += '<span class="w2ui-info '+ col.info.icon +'" style="'+ (col.info.style || '') + '" '+
                    ' onmouseover="event.stopPropagation(); w2ui[\''+ this.name + '\'].showBubble('+ ind +', '+ col_ind +')"></span>';
            }
            // various renderers
            if (col.render != null) {

...
(function ($) {
    ...
    $.fn.w2grid = function(method) {
        if ($.isPlainObject(method)) {
            ...
            // (object.onExpand != null) object.show.expandColumn = false; // setting to false to prevent extra column on grid
    ...
    w2grid.prototype = {
        ...
        render: function (box) {
            ...
            function mouseStart (event) {
                ...
                /*
                //ATHENA-ALTERATION
                 -- Begin Custom Change by Michael Fisher on 6-29-2016

                 Removes the user having to hold down the 'alt' key just to select text from the grid
                 and have the sort feature enabled at the same time.
                 */
                if (!event.altKey) {
        ...
        initColumnOnOff: function () {
            ...
            for (var c = 0; c < this.columns.length; c++) {
                ...
                if (col.hideable === false || col.hideable === 0) continue; //edited by ke314w 10/26/2016 ATHENA-ALTERATION
        ...
        initColumnDrag: function ( box ) {
            ...
            var obj = this,
                _dragData = {};
                _dragData.lastInt = undefined; //Custom Change by ke314w on 10-06-2016 ATHENA-ALTERATION
            ...
            function dragColStart ( event ) {
                ...
                _dragData.timeout = setTimeout(function(){
                    ...
                    var edata,
                        ...
                        selectedCol,
                        origColumn,
                        origColumnNumber,                                                              //by ke314w
                        invalidPreColumns = [ 'w2ui-col-number', 'w2ui-col-expand', 'w2ui-col-select', 'w2ui-nodrag-cols-head' ],
                        invalidPostColumns = [ 'w2ui-head-last' ],
                        invalidColumns = invalidPreColumns.concat( invalidPostColumns ),               //by ke314w
                        preColumnsSelector = '.w2ui-col-number, .w2ui-col-expand, .w2ui-col-select, .w2ui-nodrag-cols-head',                  //by ke314w
                        preColHeadersSelector = '.w2ui-head.w2ui-col-number, .w2ui-head.w2ui-col-expand, .w2ui-head.w2ui-col-select .w2ui-head.w2ui-nodrag-cols-head';
                    ...
                    $( _dragData.ghost ).css({
                        ...
                        opacity: 0
                            ...
                            left : event.clientX, //originally pageX, Custom Change by ke314w ATHENA-ALTERATION
                            top : event.clientY, //originally pageX, Custom Change by ke314w ATHENA-ALTERATION
                            opacity: 0.8
                        }, 0 );
            ...
            function dragColOver ( event ) {
                ...
                var cursorX = event.originalEvent.clientX, //originally pageX, Custom Change by ke314w, ATHENA-ALTERATION
                    cursorY = event.originalEvent.clientY, //originally pageY, Custom Change by ke314w, ATHENA-ALTERATION
            ...
            function dragColEnd ( event ) {
                ...
                //Custom Change by ke314w
                var targetColumnClassNames = targetColumn[0].className.split(' ');
                var targetColumnNextSiblingClassNames = targetColumn[0].nextSibling.className.split(' ');
                var targetColumnCombinedClassNames = targetColumnClassNames.concat(targetColumnNextSiblingClassNames);
                var targetValid = true;
                var index = targetColumnCombinedClassNames.indexOf('w2ui-nodrag-cols-head');
                if(index !== -1){
                  targetValid = false;
                }
                                                                                                                              ...
                                                                                                                              //Custom Change by ke314w
                if ( target !== _dragData.originalPos + 1 && target !== _dragData.originalPos && targetColumn && targetColumn.length && targetValid) {

                  //Custom Change by ke314w
                  // Removed animation for Athena
...
//                    break;
        ...
        getColumnCellHTML: function (i) {
            ...
            // frozen style by ke314w
            var dragCols = (col.draggable || col.draggable === undefined) ? '' : ' w2ui-nodrag-cols-head';
            if(dragCols){
              reorderCols = '';
            }
            ...
            var html = '<td id="grid_'+ this.name + '_column_' + i +'" col="'+ i +'" class="w2ui-head '+ sortStyle + reorderCols + dragCols + '" ' + // frozenCols style by ke314w

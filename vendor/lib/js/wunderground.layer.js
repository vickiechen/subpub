...
L.Wunderground = (L.Layer?L.Layer:L.Class).extend({
	...
	initialize: function (options) {
		...
		//Animated Radar only  (by ke314w)
		this._urlTemplate = 'http://api.wunderground.com/api/{appId}/radar/image.gif?maxlat={radmaxlat}&maxlon={radmaxlon}&minlat={radminlat}&minlon={radminlon}&width={radwidth}&height={radheight}&rainsnow=1&reproj.automerc=1&noclutter=1&num=8&delay=50&timelabel=1';
	...
	update: function () {
		...
		var url = this._urlTemplate
					...
					// .replace('{satmaxlat}', bounds.getNorth().toFixed(2)) //ADD these lines back to show satellite (by ke314w)
